...
mpl.use('Qt5Agg') # Force mpl backend not to use qt. Else we have a conflict.
import numpy as np
import pickle
import time
...
class Extrapolators(object):
    ...
    def __init__(self, map_magnetogram, **kwargs):
        ...
        self.xobsrange = kwargs.get('xrange')
        self.yobsrange = kwargs.get('yrange') 
